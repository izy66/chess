...
SOURCES = pieces/blank.cc pieces/piece.cc pieces/king.cc subject.cc pieces/iterators/king_iterator.cc pieces/iterators/queen_iterator.cc pieces/iterators/bishop_iterator.cc pieces/iterators/knight_iterator.cc pieces/iterators/rook_iterator.cc pieces/iterators/pawn_iterator.cc textui.cc kingmove.cc queenmove.cc pawnmove.cc bishopmove.cc rookmove.cc knightmove.cc decisiontree.cc parser.cc controller.cc board.cc chessboard.cc game.cc main.cc     # source files (*.cc)
