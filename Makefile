...
FILE_LIST = moves/move.cc moves/king_move.cc moves/pawn_move.cc player/parser.cc player/vision.cc player/player.cc player/human_player.cc player/computer_player.cc player/computer_level_1.cc player/computer_level_2.cc player/computer_level_3.cc player/computer_level_4.cc pieces/blank.cc pieces/piece.cc pieces/king.cc pieces/pawn.cc subject.cc pieces/iterators/king_iterator.cc pieces/iterators/queen_iterator.cc pieces/iterators/bishop_iterator.cc pieces/iterators/knight_iterator.cc pieces/iterators/rook_iterator.cc pieces/iterators/pawn_iterator.cc text_ui.cc graphics_ui.cc controller.cc board.cc chessboard.cc game.cc window.cc main.cc
