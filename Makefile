...
FILE_LIST = moves/move.cc moves/king_move.cc moves/pawn_move.cc player/parser.cc player/player.cc player/human_player.cc player/computer_player.cc player/random_player.cc player/beginner_player.cc pieces/blank.cc pieces/piece.cc subject.cc pieces/iterators/king_iterator.cc pieces/iterators/queen_iterator.cc pieces/iterators/bishop_iterator.cc pieces/iterators/knight_iterator.cc pieces/iterators/rook_iterator.cc pieces/iterators/pawn_iterator.cc textui.cc controller.cc board.cc chessboard.cc game.cc window.cc main.cc
